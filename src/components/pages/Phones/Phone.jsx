        ...
        <div>
            <div className='pt-4'>
                <div className='review pt-2'>
                    <div className='text-primary h5 mt-1'>{props.phone.name}</div>
                    <span className='bg-success p-1 rounded'>{props.phone.rating}<img src="data:image/svg+xml;base64," alt='img' /></span>
                    <span className='bg-white'>{props.phone.num} Ratings&nbsp;</span>
                    <span>&amp;</span>
                    <span>&nbsp;{props.phone.review} Reviews </span>
                    <span><img height="21" src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/fa_62673a.png" alt='img' /></span>
                    <div className=' pt-1'>
                        <span className='text-success'>Extra ₹{props.phone.extra} off</span>
                        <h4>₹{props.phone.price}<span className='text-success h6'> {props.phone.off} off</span></h4>
                        <div>
            ...
            <div className='col-3 image'>
                <img className='img border m-2' src={props.phone.url} height={150} width={215} alt='relame' />
                <div>
