        ...
        <div className='m-2 '>
             ...
             <div>
                 <div className='review pt-2'>
                     <div className='text-primary h5'>{props.shirt.name}</div>
                     <span className='bg-success p-1 rounded'>{props.shirt.rating}<img src="data:image/svg+xml;base64," alt='img' /></span>
                     <span className='bg-white'> {props.shirt.num} Ratings&nbsp;</span>
                     <span>&amp;</span>
                     <span>&nbsp;{props.shirt.review} Reviews </span>
                     <span><img height="21" src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/fa_62673a.png" alt='img' /></span>
                     <div className=' pt-1'>
                         <span className='text-success'>Extra ₹{props.shirt.extra} off</span>
                         <h4>₹{props.shirt.price}<span className='text-success'> {props.shirt.off} off</span></h4>
                         <div>
         ...
         <div className=' image '>
             <img className='img border'src={props.shirt.url} alt='T-shirt'/>
             <div>
